...
*** Variables ***
# Checkout
${checkout_locator.div_product_detail}    xpath=//div[@class='product-detail']
...
${checkout_locator.h1_select_payment_method}    xpath=//h1[text()='Select Payment Method']
...
${checkout_locator.h1_payment_details}    xpath=//h1[text()='${checkout_translation.payment_details}']
...
${checkout_locator.div_payment_complete}    xpath=//div[text()=' ${checkout_translation.payment_complete} ']

# Verify Checkout
${checkout_locator.div_my_order}    xpath=//div[text()='${myorder_translation.my_order}']
${checkout_locator.div_preparing}    xpath=//div[text()='${myorder_translation.preparing}']
${checkout_locator.tr_order}    xpath=//tr[1]
